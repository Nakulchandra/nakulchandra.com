...
--------------------------------------------------
    ...
    Template Name: Baha - Personal testimonial Template
    Author: Malyarchuk
    Copyright: 2019
...
Table of Content
	...
	1. Preloader
	2. Sound Start
	3. Isotope testimonial Setup
	4. Blogs Masonry Setup
	5. Active Current Link
	6. Mobile Toggle Click Setup
	7. Testimonials OwlCarousel
	8. Chart Setup
	9. testimonial Tilt Setup
	10. testimonial Image Link
	11. testimonial Video Link
	12. Blog Video Link
...
$(window).on('load', function() {
    ...
    if( $('.testimonial-items').length ) {
        var $elements = $(".testimonial-items"),
            $filters = $('.testimonial-filter ul li');
        $elements.isotope();
...
$(document).ready(function() {
	...
	/* -----------------------------------
	      	9. testimonial Tilt Setup
	----------------------------------- */
    $('.pt-testimonial .testimonial-items .item figure').tilt({
        maxTilt: 3,
        glare: true,
        maxGlare: .6,
        reverse: true
	...
	/* -----------------------------------
	      10. testimonial Image Link
	----------------------------------- */
	$(".testimonial-items .image-link").magnificPopup({
		type: "image"
	});
	...
	/* -----------------------------------
	      11. testimonial Video Link
	----------------------------------- */
	$(".testimonial-items .video-link").magnificPopup({
		type: "iframe"
	});
